	...
	*/
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_mobile_background_color', array(
			'label' 				=> esc_html__( 'Header background color mobile', 'physio-qt' ),
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_desktop_background_color', array(
			'label' 				=> esc_html__( 'Header background color desktop', 'physio-qt' ),
			'section' 				=> 'section_header',
		...
		$wp_customize->add_control( 'featured_button_text', array(
		    'label' 				=> esc_html__( 'Featured button text', 'physio-qt' ),
		    'section' 				=> 'section_header',
		...
		$wp_customize->add_control( 'featured_button_url', array(
		    'label' 				=> esc_html__( 'Featured button url', 'physio-qt' ),
		    'section' 				=> 'section_header',
		...
		$wp_customize->add_control( 'featured_button_target', array(
			'label'       			=> esc_html__( 'Featured button target', 'physio-qt' ),
			'section'				=> 'section_header',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'featured_button_text_color', array(
			'label'       			=> esc_html__( 'Featured button text color', 'physio-qt' ),
			'section'     			=> 'section_header',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'featured_button_background_color', array(
			'label'       			=> esc_html__( 'Featured button background color', 'physio-qt' ),
			'section'     			=> 'section_header',
		...
		$wp_customize->add_control( 'featured_button', array(
			'label'    				=> esc_html__( 'Featured button on desktop', 'physio-qt' ),
			'section'  				=> 'section_header',
		...
		$wp_customize->add_control( 'featured_button_mobile', array(
			'label'    				=> esc_html__( 'Featured button on mobile', 'physio-qt' ),
			'section'  				=> 'section_header',
		...
		$wp_customize->add_control( 'header_widgets_absolute', array(
			'label'    				=> esc_html__( 'Header widget bar position', 'physio-qt' ),
			'description'    		=> esc_html__( 'Select if you want to let the header widget bar overlay the slider and page header.', 'physio-qt' ),
			'section'  				=> 'section_header',
			'settings' 				=> 'header_widgets_absolute',
			'type'     				=> 'select',
			'choices'  				=> array(
				'overlay' 	 		=> esc_html__( 'Overlay', 'physio-qt' ),
				'no_overlay' 		=> esc_html__( 'No overlay', 'physio-qt' ),
			),
		) );
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_widgets_text_color', array(
			'label'       			=> esc_html__( 'Header widgets text color', 'physio-qt' ),
			'section'     			=> 'section_header',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_widgets_background_color', array(
			'label'       			=> esc_html__( 'Header widget bar background color', 'physio-qt' ),
			'section'     			=> 'section_header',
		...
		$wp_customize->add_control( 'header_widgets_background_opacity', array(
		    'label' 				=> esc_html__( 'Header widget bar background opacity', 'physio-qt' ),
		...
		$wp_customize->add_control( 'header_widgets_margin_desktop_small', array(
		    'label' 				=> esc_html__( 'Header widgets margin right small', 'physio-qt' ),
		...
		$wp_customize->add_control( 'header_widgets_margin_desktop_large', array(
		    'label' 				=> esc_html__( 'Header widgets margin right large', 'physio-qt' ),
		...
		$wp_customize->add_control( 'blog_excerpt_length', array(
	    	...
	    	'description' 		=> esc_html__( 'Set a custom length for all blog excerpt text. This will overrule the default read more tag', 'physio-qt' ),
	    	'section' 			=> 'section_blog',
		...
		$wp_customize->add_setting( 'bottom_footer_left', array(
	    	'default' 				=> 'Copyright 2017 Physio WP by Qreativethemes',
	    	'transport'				=> 'refresh',
	    	'sanitize_callback' 	=> 'physio_qt_sanitize_text',
		) );
